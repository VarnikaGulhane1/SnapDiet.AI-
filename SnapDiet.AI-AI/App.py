...
st.set_page_config(page_title="🤖VitaGlow.AI", layout="wide")
...
st.sidebar.markdown("👨‍💻 **Developer:** Varnika")
...
st.markdown("<h1 style='text-align: center;'>🤖 VitaGlow.AI – AI-Powered by Varnika</h1>", unsafe_allow_html=True)
